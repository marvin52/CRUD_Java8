...
<%@ include file="cabecalho.jsp"%>
	...
	<form action="trataform.jsp" method="post">
		...
		<input required id="nome_id" class="form-control" type="text" name="nome"><br>
		</div>
		<div class="form-group" style="margin-bottom: 0">
		<label for="email_id">E-mail:</label>
		<input required id="email_id" class="form-control" type="email" name="email"><br>
		</div>
		<div class="form-group" style="margin-bottom: 0">
			<label for="data_nascimento_id">Data de nascimento:</label>
		<input required id="data_nascimento_id"  class="form-control" type="date" name="data_nascimento" value="Enviar"><br>
		</div>
